package com.example.fighther.viewmodels;
...
import com.example.fighther.repositories.ItemRepository;
        ...
        itemRepository.getAllItems(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot itemSnapshot : dataSnapshot.getChildren()) {
                    String titulo = itemSnapshot.child("titulo").getValue(String.class);
                    String descripcion = itemSnapshot.child("descripcion").getValue(String.class);
